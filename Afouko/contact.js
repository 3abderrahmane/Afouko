const renderContactPage = (() => {
    ...
    <section class="contact-me" id="contact-me">
      ...
      <div class="row2">
        <div class="col1 formdata">
          <form id="contact-form" method="post" action="http://localhost:3000/sign_up">
            ...
            <textarea rows="6" cols="60" placeholder="Message" name="message" id="message" required=""></textarea>
  ...
  <footer>
         <span id="copyrightyear">"© Copyright 2024 by A. Chagour ERER Design"</span>
  </footer>`;
